...
#dorian
fgfs="profiles/profile2d4_2019_dorain_gfs.nc"
fgfs_o=fgfs[0:len(fgfs)-3]+"_output.nc"

fhg="profiles/profile_dorian_2019090218_f003_hgfs.nc"
fhg_o="profile_dorian_2019090218_f003_hgfs_output.nc"
fhh="profiles/profile_dorian_2019090218_f003_hwrf.nc"
fhh_o="profile_dorian_2019090218_f003_hgfs_output.nc"
fobs="obs_grid.nc"
...
def main(coefficientPath, sensor_id, fin, experiment):
    ...
    profiles.surfaceFractions[:,1]=np.where((lands==0)|(lands==np.nan) ,int(1),int(0))
...
if __name__ == "__main__":
    ...
    sensor_id = 'abi_g16'
    #main(coefficientPath, sensor_id, fgfs,  cntrl)
    main(coefficientPath, sensor_id, fhg,  cntrl)
    main(coefficientPath, sensor_id, fhh,  cntrl)
